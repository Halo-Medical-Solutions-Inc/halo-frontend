        ...
        <div className="mx-auto h-full w-full max-w-3xl rounded-xl space-y-8">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="name" type="text" placeholder="John Doe" value={user.name} className={nameError ? "!border-destructive !ring-destructive" : ""} />
            ...
            <div className="space-y-2">
              ...
              <Input id="email" type="email" placeholder="email@halo.com" value={user.email} className={emailError ? "!border-destructive !ring-destructive" : ""} />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select defaultValue={user.default_template_id}>
            ...
            <div className="space-y-2">
              ...
              <Select defaultValue={user.default_language}>
                <SelectTrigger className="min-w-[50px] max-w-[240px] w-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="retypePassword" type="password" placeholder="********" />
            </div>
            <Button type="submit">
              Update Password
            </Button>
