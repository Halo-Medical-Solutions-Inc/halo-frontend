...
const ExpandingTextarea = React.forwardRef<HTMLTextAreaElement, ExpandingTextareaProps>(({ className, minHeight = 0, maxHeight, onChange, value, ...props }, ref) => {
  ...
  return (
    <textarea
      ...
      className={cn("flex w-full rounded-lg bg-background text-sm text-muted-foreground placeholder:text-muted-foreground/70 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 leading-normal", className)}
