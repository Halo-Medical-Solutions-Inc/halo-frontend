...
export default function AskAIComponent() {
  ...
  const messages = [
    ...
    },
    {
      id: 5,
      content:
        "Creating a new template is easy! Navigate to the Templates section from the sidebar, then click the 'Create Template' button. You'll be guided through a simple form to set up your template.",
      sender: "ai",
    },
  ];
