...
export default function NoteComponent() {
  const selectedVisit = {
    ...
    note: "", 
    additional_context: "Patient reports occasional headaches and mild insomnia",
  ...
  const templates = [
    { _id: "template1", name: "SOAP Note", modified_at: "2023-08-10T12:00:00.000Z" },
    { _id: "template2", name: "Progress Note", modified_at: "2023-08-11T12:00:00.000Z" },
    { _id: "template3", name: "Consultation", modified_at: "2023-07-20T12:00:00.000Z" }
  ];
      ...
      <header className="flex h-14 shrink-0 items-center gap-2">
        <div className="flex flex-1 items-center gap-2 px-3">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbPage className="line-clamp-1">{selectedVisit.name}</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
        ...
        <div className="mx-auto h-full w-full max-w-3xl rounded-xl space-y-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between w-full gap-4">
            ...
            <div className="flex items-center gap-2">
              <Select defaultValue={selectedVisit.template_id}>
          ...
          {selectedVisit.template_modified_at && 
           templates.find(t => t._id === selectedVisit.template_id)?.modified_at && 
           new Date(selectedVisit.template_modified_at) < new Date(templates.find(t => t._id === selectedVisit.template_id)?.modified_at || "") && 
           transcriptView && (
                    ...
                    <div className="w-full flex items-center relative group">
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <span
                            className="text-sm font-bold text-primary truncate cursor-pointer hover:text-primary/80"
                          >
                            TRANSCRIPT
                          </span>
                        </TooltipTrigger>
                ...
                <div key={index} className="flex flex-col">
                  ...
                  <div className="relative group mt-2">
                    <ExpandingTextarea
                      ...
                      maxHeight={10000}
                      value={section.body}
                      className="w-full text-muted-foreground text-sm flex-1 resize-none border-none p-0 leading-relaxed focus:ring-0 focus:outline-none focus:shadow-none placeholder:text-muted-foreground"
                    />
                  </div>
                </div>
              ))
